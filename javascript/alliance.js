...
/* Fighting */ 
//IMPORTANTE TA MAL a partir de else if
...
function generatefighting(){
 ...
 if (alliance === "Cipher Pol") {
  ...
  var fighting = capFirst(fightings[getRandomInt(0, fightings.length + 1)]);
  document.getElementById("fighting").innerHTML = fighting;
}

/* Haki */
//IMPORTANTE TA MAL a partir de if
...
function assignhaki(){
 ...
 if (fighting === "Dragon Claw") {
  ...
  var haki = capFirst(hakis[getRandomInt(0, hakis.length + 1)]);
