...
//----------------------------------------------------------------------------
     ...
     ranks = ["Celestial Dragon","King/Queen"];
  } else if(rank === "Prince/Princess" && alliance2 === "World Nobles") {                            
     ranks = ["King/Queen","Prince/Princess"];
  } else if(rank === "Noble Commander" && alliance2 === "World Nobles") {                            
     ranks = ["King/Queen","Prince/Princess","Noble Commander"];
  } else if(rank === "Soldier" && alliance2 === "World Nobles") {                            
     ranks = ["King/Queen","Prince/Princess","Noble Commander","Soldier"];
...
function adddoriki() {
 if (rank === "Fleet Admiral") { // ----------------------------------- Marine
     adddorikis = getRandomInt(30000, 60000 + 1);
  } else if(rank === "Admiral") {
     adddorikis = getRandomInt(15000, 30000 + 1);
  } else if(rank === "Vice Admiral") {
     adddorikis = getRandomInt(8000, 15000 + 1);
  } else if(rank === "Rear Admiral") {
     adddorikis = getRandomInt(3000, 8000 + 1);
  } else if(rank === "Commodore") {
     adddorikis = getRandomInt(1000, 3000 + 1);
  } else if(rank === "Captain") {
     adddorikis = getRandomInt(400, 1000 + 1);
  } else if(rank === "Commander") {
     adddorikis = getRandomInt(200, 400 + 1);
  } else if(rank === "Lieutenant") {
    adddorikis = getRandomInt(100, 200 + 1);
  } else if(rank === "Commodore") {
     adddorikis = getRandomInt(50, 100 + 1);
  } else if(rank === "Ensign") {
     adddorikis = getRandomInt(30, 50 + 1);
  } else if(rank === "Petty Officer") {
     adddorikis = getRandomInt(10, 30 + 1);
  } else if(rank === "Seaman") {
     adddorikis = getRandomInt(5, 10 + 1);
  } else if(rank === "Choreboy") {
     adddorikis = getRandomInt(1, 5 + 1);
  } else if(rank === "Inspector General") {
     adddorikis = getRandomInt(3000, 15000 + 1);
  } else if(rank === "Instructor") {
     adddorikis = getRandomInt(1500, 10000 + 1);
  } else if(rank === "CP0") { // ----------------------------------- Cipher Pol
     adddorikis = getRandomInt(20000, 25000 + 1);
  } else if(rank === "CP1") {
     adddorikis = getRandomInt(18000, 20000 + 1);
  } else if(rank === "CP2") {
    adddorikis = getRandomInt(16000, 18000 + 1);
  } else if(rank === "CP3") {
     adddorikis = getRandomInt(14000, 16000 + 1);
  } else if(rank === "CP4") {
     adddorikis = getRandomInt(12000, 14000 + 1);
  } else if(rank === "CP5") {
     adddorikis = getRandomInt(10000, 12000 + 1);
  } else if(rank === "CP6") {
     adddorikis = getRandomInt(8000, 10000 + 1);
  } else if(rank === "CP7") {
     adddorikis = getRandomInt(6000, 8000 + 1);
  } else if(rank === "CP8") {
     adddorikis = getRandomInt(4000, 6000 + 1);
  } else if(rank === "CP9") {
     adddorikis = getRandomInt(500, 4000 + 1);
  } else if(bountyfinal === 0) {
     adddorikis = getRandomInt(1, 20 + 1);
  } else {
     adddorikis = bountyfinal / 0.075 ;
  }

  adddoriki = adddorikis
  document.getElementById("adddoriki").innerHTML = parseInt(adddorikis);
}
...
function adddoriki2() {
  ...
  if (rank === "Fleet Admiral") { // ----------------------------------- Marine
     adddorikis2 = getRandomInt(30000, 60000 + 1);
  } else if(rank2 === "Admiral") {
     adddorikis2 = getRandomInt(15000, 30000 + 1);
  } else if(rank2 === "Vice Admiral") {
     adddorikis2 = getRandomInt(8000, 15000 + 1);
  } else if(rank2 === "Rear Admiral") {
     adddorikis2 = getRandomInt(3000, 8000 + 1);
  } else if(rank2 === "Commodore") {
     adddorikis2 = getRandomInt(1000, 3000 + 1);
  } else if(rank2 === "Captain") {
     adddorikis2 = getRandomInt(400, 1000 + 1);
  } else if(rank2 === "Commander") {
     adddorikis2 = getRandomInt(200, 400 + 1);
  } else if(rank2 === "Lieutenant") {
    adddorikis2 = getRandomInt(100, 200 + 1);
  } else if(rank2 === "Commodore") {
     adddorikis2 = getRandomInt(50, 100 + 1);
  } else if(rank2 === "Ensign") {
     adddorikis2 = getRandomInt(30, 50 + 1);
  } else if(rank2 === "Petty Officer") {
     adddorikis2 = getRandomInt(10, 30 + 1);
  } else if(rank2 === "Seaman") {
     adddorikis2 = getRandomInt(5, 10 + 1);
  } else if(rank2 === "Choreboy") {
     adddorikis2 = getRandomInt(1, 5 + 1);
  } else if(rank2 === "Inspector General") {
     adddorikis2 = getRandomInt(3000, 15000 + 1);
  } else if(rank2 === "Instructor") {
     adddorikis2 = getRandomInt(1500, 10000 + 1);
  } else if(rank2 === "CP0") { // ----------------------------------- Cipher Pol
     adddorikis2 = getRandomInt(20000, 25000 + 1);
  } else if(rank2 === "CP1") {
     adddorikis2 = getRandomInt(18000, 20000 + 1);
  } else if(rank2 === "CP2") {
    adddorikis2 = getRandomInt(16000, 18000 + 1);
  } else if(rank2 === "CP3") {
     adddorikis2 = getRandomInt(14000, 16000 + 1);
  } else if(rank2 === "CP4") {
     adddorikis2 = getRandomInt(12000, 14000 + 1);
  } else if(rank2 === "CP5") {
     adddorikis2 = getRandomInt(10000, 12000 + 1);
  } else if(rank2 === "CP6") {
     adddorikis2 = getRandomInt(8000, 10000 + 1);
  } else if(rank2 === "CP7") {
     adddorikis2 = getRandomInt(6000, 8000 + 1);
  } else if(rank2 === "CP8") {
     adddorikis2 = getRandomInt(4000, 6000 + 1);
  } else if(rank2 === "CP9") {
     adddorikis2 = getRandomInt(500, 4000 + 1);
  } else if(bountyfinal2 === 0) {
     adddorikis2 = getRandomInt(1, 20 + 1);
  } else {
     adddorikis2 = bountyfinal2 / 0.075 ;
  }

  adddoriki2 = adddorikis2
  document.getElementById("adddoriki2").innerHTML = parseInt(adddorikis2);
}